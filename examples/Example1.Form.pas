...
procedure TForm1.BtnListEmployeesClick(Sender: TObject);
var
  Employee: TEmployee;
  S: string;
begin
...
procedure TForm1.BtnListCustomersClick(Sender: TObject);
var
  Customer: TCustomer;
  S: string;
begin
...
procedure TForm1.GrdCustomerDblClick(Sender: TObject);
var
  Customer: TCustomer;
begin
...
procedure TForm1.GrdEmployeeDblClick(Sender: TObject);
var
  Employee: TEmployee;
begin
